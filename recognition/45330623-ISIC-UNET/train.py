...
train_features, train_labels = next(iter(dataset.train_loader))
print(f"Feature batch shape: {train_features.size()}")
print(f"Labels batch shape: {train_labels.size()}")
history = fit(epoch, modules.model, dataset.train_loader, dataset.val_loader, criterion, optimizer, sched)